...
* end-to-end encryption (for security and privacy): 
  ...
  * encrypted msg are stored as scrambled text. So if you uninstall your app, you will get a new secret key and the old encrypted data will be gone, because the decrypted text only stored on your device
